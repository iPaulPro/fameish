  ...
  return (
    <div className="bg-background">
      ...
      <div className="max-w-2xl mx-auto px-4 py-8 flex flex-col gap-4">
        ...
        <ul className="flex flex-col gap-2">
          ...
          <li>
            <p>
              ...
              &quot;Our&quot; in this Agreement) refers to Fameish.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to Fameish, accessible from{" "}
              <a href="https://fameish.day" rel="external nofollow noopener" target="_blank">
                https://fameish.day
              </a>
            </p>
          </li>
        ...
        <h2 className="text-xl font-semibold">&quot;AS IS&quot; and &quot;AS AVAILABLE&quot; Disclaimer</h2>
        <p>
        ...
        <h2 className="text-xl font-semibold">For European Union (EU) Users</h2>
        <p>
        ...
        <h2 className="text-xl font-semibold">United States Legal Compliance</h2>
        <p>
        ...
        <h2 className="text-xl font-semibold">Severability and Waiver</h2>
        ...
        <ul>
          <li>By email: contact@fameish.day</li>
        </ul>
      </div>
    </div>
  );
