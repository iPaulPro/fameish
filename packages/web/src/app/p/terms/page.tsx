...
export default function TermsPage() {
  return (
    <div className="bg-background">
      ...
      />
      <div data-custom-class="body" className="max-w-2xl mx-auto px-4 py-8">
        ...
        <div align="center" style={{ textAlign: "left" }}>
          <div className="MsoNormal" data-custom-class="body_text" style={{ lineHeight: "1.5" }}>
            ...
            >
              ...
              <bdt className="block-component" />, doing business as <bdt className="question">fameish.day</bdt>
              <bdt className="block-component" />
              <bdt className="statement-end-if-in-editor" /> (
        ...
        <div align="center" style={{ textAlign: "left" }}>
          <div className="MsoNormal" data-custom-class="body_text" style={{ lineHeight: "1.5" }}>
            ...
            >
              ...
              <span style={{ color: "rgb(0, 58, 250)" }}>
                <bdt className="question">fameish.day</bdt>
              </span>{" "}
          ...
          <div className="MsoNormal" data-custom-class="body_text" style={{ lineHeight: "1.5" }}>
            ...
            >
              ...
              <bdt className="block-component">
                email at <bdt className="question">contact@fameish.day</bdt>
                <bdt className="block-component" />
                <bdt className="block-component" />
                <bdt className="block-component" />
                <bdt className="block-component">
          ...
          <div className="MsoNormal" data-custom-class="body_text" style={{ lineHeight: "1.5" }}>
            ...
            >
              ...
              <bdt className="statement-end-if-in-editor" />
              ), and <bdt className="question">Paul Burke</bdt>, concerning your access to and use of the Services. You
          ...
          <div className="MsoNormal" data-custom-class="body_text" style={{ lineHeight: "1.5" }}>
            ...
            >
              ...
              from time to time
              <bdt className="else-block" />. We will alert you about any changes by updating the{" "}
              <bdt className="block-component" />
              "Last updated"
        ...
        <div align="center" style={{ textAlign: "left" }}>
          ...
          <div className="MsoNormal" style={{ lineHeight: "1.5" }}>
            <a data-custom-class="link" href="#modifications">
              <span style={{ color: "rgb(0, 58, 250)", fontSize: 15 }}>
                <span data-custom-class="body_text">14. MODIFICATIONS AND INTERRUPTIONS</span>
              </span>
            </a>{" "}
          ...
          <div className="MsoNormal" style={{ lineHeight: "1.5" }}>
            <a data-custom-class="link" href="#electronic">
              <span style={{ color: "rgb(0, 58, 250)", fontSize: 15 }}>
                <span data-custom-class="body_text">22. ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES</span>
              </span>
            </a>{" "}
          ...
          <div className="MsoNormal" style={{ lineHeight: "1.5" }}>
            ...
            <a data-custom-class="link" href="#addclause">
              <span style={{ color: "rgb(0, 58, 250)" }}>
                <span data-custom-class="body_text">
                  25. <bdt className="question">BLOCKCHAIN INTERACTION; USE OF LENS PROTOCOL</bdt>
                </span>
              </span>
            </a>
            <bdt className="statement-end-if-in-editor">
        ...
        <div align="center" style={{ textAlign: "left" }}>
          ...
          <div className="MsoNormal" data-custom-class="body_text" style={{ lineHeight: "1.5" }}>
            ...
            >
              ...
              property rights and unfair competition laws) and treaties
          ...
          <div className="MsoNormal" data-custom-class="body_text" style={{ lineHeight: "1.5" }}>
            ...
            >
              ...
              <bdt className="question">contact@fameish.day</bdt>. If we ever grant you the permission to post,
              reproduce, or publicly display any part of our Services or Content, you must identify us as the owners or
              licensors of the Services, Content, or Marks and ensure that any copyright or proprietary notice appears
        ...
        <div align="center" style={{ textAlign: "left" }}>
          ...
          <ul>
            <li className="MsoNormal" data-custom-class="body_text" style={{ lineHeight: "1.5" }}>
              ...
              <span style={{ fontSize: 15 }}>
                ...
                <bdt className="block-component" /> that is illegal, harassing, hateful, harmful, defamatory, obscene,
            ...
            <li className="MsoNormal" data-custom-class="body_text" style={{ lineHeight: "1.5" }}>
              <span style={{ fontSize: 15 }}>
                ...
                <bdt className="block-component" /> are original to you or that you have the necessary rights and{" "}
                <bdt className="block-component" />
                licenses
                <bdt className="statement-end-if-in-editor" /> to submit such Submissions
                <bdt className="block-component" /> and that you have full authority to grant us the above-mentioned
          ...
          <div className="MsoNormal" data-custom-class="body_text" style={{ lineHeight: "1.5" }}>
            ...
            <bdt className="block-component" /> and you expressly agree to reimburse us for any and all losses that we
            may suffer because of your breach of (a) this section, (b) any third party’s intellectual property rights,
            or (c) applicable law.
            <bdt className="block-component" />
            <bdt className="block-component" />
          </div>
            ...
            <bdt className="block-container if" data-type="if" id="8d4c883b-bc2c-f0b4-da3e-6d0ee51aca13">
              <bdt data-type="conditional-block">
                ...
                <bdt data-type="body">
                  ...
                  <span style={{ color: "rgb(89, 89, 89)", fontSize: "11pt" }}>) you are not under the age of 13;</span>
                </bdt>
              </bdt>
              <bdt className="statement-end-if-in-editor" data-type="close" />
              &nbsp;
            ...
            <span style={{ color: "rgb(89, 89, 89)", fontSize: "11pt" }}>
              ...
              <bdt className="block-container if" data-type="if" id="76948fab-ec9e-266a-bb91-948929c050c9">
                <bdt data-type="conditional-block">
                  ...
                  <bdt data-type="body">, or if a minor, you have received parental permission to use the Services</bdt>
                </bdt>
                <bdt className="statement-end-if-in-editor" data-type="close" />
              </bdt>
              ; (
          ...
          <div className="MsoNormal" style={{ textAlign: "justify", lineHeight: "115%" }}>
                            ...
                            >
                              <bdt data-type="conditional-block">
                                ...
                                >
                                  ...
                                  <bdt className="block-component" /> We may provide you with the opportunity to create,
                                  submit, post, display, transmit, perform, publish, distribute, or broadcast content
                                  and materials to us or on the Services, including but not limited to text, writings,
                                  video, audio, photographs, graphics, comments, suggestions, or personal information or
                                  other material (collectively, <bdt className="block-component" />
                                  "Contributions"
                                  <bdt className="statement-end-if-in-editor" />
                                  ). Contributions may be viewable by other users of the Services and through
                                  third-party websites.
                                  <bdt className="block-component" /> As such, any Contributions you transmit may be
                                  treated in accordance with the Services' Privacy Policy.
                                  <bdt className="statement-end-if-in-editor" /> When you create or make available any
                    ...
                    <span style={{ color: "rgb(89, 89, 89)" }}>
                      <span style={{ fontSize: 14 }}>
                        <span data-custom-class="body_text">
                          ...
                          authorize
                          <bdt className="statement-end-if-in-editor" /> us, the Services, and other users of the
                          Services to use your Contributions in any manner contemplated by the Services and these Legal
                          Terms.
                        </span>
                      </span>
                    </span>
            ...
            <div className="MsoNormal" data-custom-class="body_text" style={{ lineHeight: "1.5" }}>
              ...
              >
                ...
                >
                  ...
                  that you provide
                  <bdt className="block-component" /> following the terms of the Privacy Policy
                  <bdt className="statement-end-if-in-editor" /> and your choices (including settings).
                </span>
              </span>
            </div>
            <div className="MsoNormal" style={{ lineHeight: "1.5" }}>
                  ...
                  <bdt data-type="body">
                    <div className="MsoNormal" data-custom-class="body_text" style={{ lineHeight: "1.5" }}>
                      ...
                      >
                        ...
                        <bdt className="block-component" />
                        "Third-Party Account"
                        <bdt className="statement-end-if-in-editor" />) by either: (1) providing your Third-Party
                        ...
                        <span style={{ fontSize: "14.6667px" }}>Third-Party</span> Account. You represent and warrant
                        that you are entitled to disclose your{" "}
                        <span style={{ fontSize: "14.6667px" }}>Third-Party</span> Account login information to us
                        and/or grant us access to your <span style={{ fontSize: "14.6667px" }}>Third-Party</span>{" "}
                        Account, without breach by you of any of the terms and conditions that govern your use of the
                        applicable <span style={{ fontSize: "14.6667px" }}>Third-Party</span> Account, and without
                        obligating us to pay any fees or making us subject to any usage limitations imposed by the
                        third-party service provider of the <span style={{ fontSize: "14.6667px" }}>Third-Party</span>{" "}
                        Account. By granting us access to any <span style={{ fontSize: "14.6667px" }}>Third-Party</span>{" "}
                        ...
                        <span style={{ fontSize: "14.6667px" }}>Third-Party</span> Account (the{" "}
                        <bdt className="block-component" />
                        "Social Network Content"
                        <bdt className="statement-end-if-in-editor" />) so that it is available on and through the
                        Services via your account, including without limitation any friend lists and (2) we may submit
                        to and receive from your <span style={{ fontSize: "14.6667px" }}>Third-Party</span> Account
                        ...
                        <span style={{ fontSize: "14.6667px" }}>Third-Party</span> Accounts you choose and subject to
                        the privacy settings that you have set in such{" "}
                        ...
                        <span style={{ fontSize: "14.6667px" }}>Third-Party</span> Accounts at any time. PLEASE NOTE
                        ...
                        with a <span style={{ fontSize: "14.6667px" }}>Third-Party</span> Account and your contacts list
                        ...
                        <span style={{ fontSize: "14.6667px" }}>Third-Party</span> Account by contacting us using the
                        ...
                        <span style={{ fontSize: "14.6667px" }}>Third-Party</span> Account, except the username and
            ...
            <div className="MsoNormal" data-custom-class="body_text" style={{ lineHeight: "1.5" }}>
              ...
              >
                ...
                relating to or resulting in any way from any <span style={{ fontSize: "14.6667px" }}>Third-Party</span>{" "}
                Content or any contact with <span style={{ fontSize: "14.6667px" }}>Third-Party</span> Websites.
              </span>
            </div>
            <div className="MsoNormal" style={{ lineHeight: "1.5" }}>
              <br />
            ...
            <div className="MsoNormal" data-custom-class="body_text" style={{ lineHeight: "1.5" }}>
              ...
              >
                ...
                <strong>
                  ...
                  <span style={{ color: "rgb(0, 58, 250)" }}>
                    <bdt
                      ...
                      data-type="question"
                    >
                      <a href="https://fameish.day/p/privacy" target="_blank" data-custom-class="link">
                        https://fameish.day/p/privacy
                      </a>
                    </bdt>
                  </span>
                </strong>
                ...
                <bdt className="block-component" />, then through your continued use of the Services, you are
            ...
            <div className="MsoNormal" data-custom-class="body_text" style={{ lineHeight: "1.5", textAlign: "left" }}>
              ...
              >
                ...
                on our Services.
                <bdt className="block-component" /> We will not be liable to you or any third party for any
            ...
            <div className="MsoNormal" data-custom-class="body_text" style={{ lineHeight: "1.5", textAlign: "left" }}>
              ...
              <span style={{ fontSize: 15 }}>
                ...
                Arbitration Association (<bdt className="block-component" />
                "AAA"
                <bdt className="statement-end-if-in-editor" />) and, where appropriate, the AAA’s Supplementary
                Procedures for Consumer Related Disputes (<bdt className="block-component" />
                "AAA Consumer Rules"
                <bdt className="statement-end-if-in-editor" />
                ...
                <bdt className="block-component" />
                <bdt className="question">Kings</bdt>, <bdt className="statement-end-if-in-editor" />
                <bdt className="block-component" />
            ...
            <div className="MsoNormal" data-custom-class="body_text" style={{ lineHeight: "1.5", textAlign: "left" }}>
              ...
              <bdt className="block-component" style={{ fontSize: 15 }} /> <bdt className="question">Kings</bdt>
              ...
              <span style={{ fontSize: 15 }}>
                ...
                defenses
                <bdt className="statement-end-if-in-editor" /> of lack of personal jurisdiction, and forum non
                conveniens with respect to venue and jurisdiction in such
                <bdt className="block-component" /> state and federal courts
                <bdt className="statement-end-if-in-editor" />. Application of the United Nations Convention on
            ...
            <div className="MsoNormal" data-custom-class="body_text" style={{ lineHeight: "1.5", textAlign: "left" }}>
              <span style={{ fontSize: 15 }}>
                ...
                more than <bdt className="question">one (1)</bdt> years after the cause of action arose.{" "}
                <bdt className="statement-end-if-in-editor" />
            ...
            <div className="MsoNormal" data-custom-class="body_text" style={{ lineHeight: "1.5", textAlign: "left" }}>
              ...
              theft, piracy, invasion of privacy, or <bdt className="block-component" />
              unauthorized
              ...
              falling within that portion of this provision found to be illegal or unenforceable and such Dispute shall
              be decided by a court of competent jurisdiction within the courts listed for jurisdiction above, and the
            ...
            <div className="MsoNormal" data-custom-class="body_text" style={{ lineHeight: "1.5", textAlign: "left" }}>
              ...
              >
                ...
                <bdt className="block-container if" data-type="if" id="475fffa5-05ca-def8-ac88-f426b238903c">
                  ...
                  <span style={{ fontSize: "14.6667px" }}>3</span>) any breach of your representations and warranties
                  set forth in these Legal Terms; (<span style={{ fontSize: "14.6667px" }}>4</span>) your violation of
                  the rights of a third party, including but not limited to intellectual property rights; or (
                  <span style={{ fontSize: "14.6667px" }}>5</span>) any overt harmful act toward any other user of the
                  Services with whom you connected via the Services. Notwithstanding the foregoing, we reserve the
                  right, at your expense, to assume the exclusive <bdt className="block-component" />
                  defense
                  ...
                  <bdt className="block-component" />
                  defense
                  <bdt className="statement-end-if-in-editor" /> of such claims. We will use reasonable efforts to
            ...
            <div className="MsoNormal" data-custom-class="body_text" style={{ lineHeight: "1.5", textAlign: "left" }}>
              <bdt className="question">
                <span style={{ fontSize: 15 }}>
                  By accessing or using the Site, you expressly authorize the Site (and its smart contracts/interfaces)
                  to interact with the Lens Protocol on your behalf for the sole purpose of performing “follow” and
                  “unfollow” operations. You acknowledge and agree that: 1. Limited Scope of Actions. The Service will
                  only submit, via your connected Lens Protocol account, transactions to follow or unfollow other Lens
                  Protocol accounts. No other on-chain actions—such as posting, commenting, voting, or any
                  administrative functions—will be performed on your behalf. 2. No Access to Tokens or Funds. Under no
                  circumstances will the Service have, store, or access your private keys, token balances, or any wallet
                  credentials. You retain sole custody of your private keys and tokens. The Service cannot—and will
                  not—spend, transfer, or otherwise manage any funds or tokens in your wallet. By continuing to use the
                  Site, you confirm that you have read, understood, and agreed to this limited authorization. If you do
                  not agree to grant the Site permission to perform these follow/unfollow operations (and only these
                  operations), you must disconnect your Lens account and cease use of any feature that requires Lens
              ...
              <strong>
                ...
                >
                  <strong>
                    <bdt className="question">
                      <bdt className="block-component" />
                      <bdt className="question">contact@fameish.day</bdt>
                      <bdt className="statement-end-if-in-editor" />
                    </bdt>
                  </strong>
                </span>
